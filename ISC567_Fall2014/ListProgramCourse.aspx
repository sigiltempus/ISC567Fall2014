<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ListProgramCourse.aspx.vb" Inherits="ISC567_Spring2013.ListProgramCourse" %>
                ...
                <tr>
                    <td colspan="2" class="auto-style2">
                        <ccJSIM:DragIFrame ID="lblHeader" runat="server" Text="" CssClass="IFrameHeader" CanDragIFrame="True" Width="100%">
                            <asp:Label ID="lblTitle" runat="server" Text="List Course" Width="90%" style="text-align: left;">
                            </asp:Label>
                            <ccJSIM:CloseIFrameButton ID="btnClose" runat="server" Interval="10" IFrameName="ifListProgramCourse" Text="[X] Close" style="text-align: right;" />
                        </ccJSIM:DragIFrame>
                    </td>
                </tr>
                <tr>
