<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WorkOnStaff.aspx.vb" Inherits="ISC567_Fall2014.ExamProvider_4" %>
...
<%--                        <ccJSIM:CloseIFrameButton ID="lbtnClose" runat="server" IFrameName="ifExamProviderFunctions" Text="[X] Close" style="text-align: right" />--%>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        &nbsp;
                        <ccJSIM:OpenIFrameButton ID="OpenIFrameButton3" runat="server" FrameSrc="WorkonExam.aspx" IFrameName="ifWorkOnExam" Text="Work On Exam"
