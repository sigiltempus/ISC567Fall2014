                ...
                <tr>
                    ...
                    <ContentTemplate>
                        <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Width="99%" Height="300px" CssClass="PanelStyle">
                            ...
                            <ccJSIM:OpenIFrameButton ID="Button3" Cssstyle="Button" runat="server" FrameSrc="AddEditExamItem.aspx?mode=edit" IFrameName="iframeAddItem" style="z-index:1; left:419px; top: 406px; position: absolute; width: 150px; background-color: #FFFAC2; font-weight: bold; font-size: 9pt; border: 1px solid #ba931c;" Text="Show Item" WidthPosition="900" HeightPosition="450" LeftPosition="530" TopPosition="160" zindex="220"/>
