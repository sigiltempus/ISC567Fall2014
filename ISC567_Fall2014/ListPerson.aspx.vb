...
#Region "Local Functions "
    ...
    Private Function AddEditUser(ByVal personId As Integer, ByVal institutionId As Integer, ByVal CurrriculumID As Integer, ByVal firstName As String, ByVal lastName As String,
        ...
        AppUser.AddEditPersonInformation(personId, institutionId, CurrriculumID, firstName, lastName, dob, email, address1, address2, city, state, zip,
