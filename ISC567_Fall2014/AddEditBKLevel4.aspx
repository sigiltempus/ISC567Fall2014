<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AddEditBKLevel4.aspx.vb" Inherits="ISC567_Spring2013.AddEditBKLevel4" %>
            ...
            <table style="height: 310px; width: 702px">
                <tr>
                    <td colspan="1" class="IFrameHeader">
                        <ccJSIM:DragIFrame ID="dgFrame" runat="server" Text="Add BK Level4" style="text-align: left">
                        </ccJSIM:DragIFrame>
                    </td>
                    <td colspan="1" class="IFrameHeader">
                        <ccJSIM:CloseIFrameLinkButton ID="CloseIFrameLinkButton1" runat="server" Text="[x] Close"
                            BorderColor="White" ForeColor="White" IFrameName="IfAddEditBKLevel4" style="text-align: right">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label6" runat="server" Text="NumberL4 - BKLevel4" style="text-align: right"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtNumberL4" runat="server" Width="25px" style="text-align: left"></asp:TextBox>
                    </td>
                </tr>            
                <tr>
                    <td>
                        <asp:Label ID="Label3" runat="server" Text="BK Level4 Title" style="text-align: right"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td >
                        <ccJSIM:SaveAndCloseIFrameButton ID="btnSave" runat="server" OnClick="btnSave_Click" IFrameName="ifAddEditBKLevel3" Interval="100"
                            Text=" [✓] SAVE " Width="100px" ParentFrame="ifListProgramBK4" ParentPage="ListProgramBK4.aspx" CssClass="Button" />
                    </td>
                </tr>
            </table>
        </div>
